$(document).ready(function(){
    $(".bxSlider").bxSlider({
        ...
        // ! carousel - 1장의 slide영역에 복수의 slide를 배치하는 slider.
        maxSlides: 3, //? default: 1. 최대 노출 슬라이드 장수.
        slideWidth: 540, //? default: 0. carousel content 당 너비.
        minSlides: 1, //? default: 1. 최소 노출 슬라이드 장수.
        shrinkItems: true, //? max / min 기준으로 우측 일부를 남기는 UI해제.
        slideMargin: 20, //? slide간 간격 설정.(다수의 slide(carousel)를 사용시에 설정필요.)
        moveSlides: 1, //? 전환시 이동할 carousel content 수
        //? wrapperClass: 'firstSlider'  default: 'bx-wrapper' 종속된 css 를 해제하고 다른 부모 class로 변경한다.
