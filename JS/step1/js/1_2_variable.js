...
// * var 변수이름 = 담길 값; var name = value;

var userName, userAge;
// ? userName = "", userAge = "";
userName = "Mark", userAge = "39";

// *case.1  동시선언 및 동시 초기화

var radius, pi; //? 한번에 동시 선언.
radius = 0, pi = 0; //? 한번에 동시 초기화.(? 숫자담을거니까 0으로 초기화)
//? radius = 10, pi = 3.14159265; 한번에 동시 값을 담기.

// *case.2 변수의 특성종합
var cup = 'Coffee'; //? 컵 변수 선언 및 Coffee 담기.
cup = 'GreenTea'; //? 컵에 담겼던 Coffee를 버리고 녹차를 담았다.
cup = 'Water'; //? 컵에 녹차를 버리고 물을 담았다.

// console.log('최종 담긴 값은? = ' + cup);
