/*
	...
	* 6. 게시판 목록 등.
    ...
    ? 4. 멤버변수 - 클래스 내부에 만들어 지며, 객체에서 사용하는 정보를 담는 변수.
    function Markclass(){
    	this.name = "멤버변수";
    }
...
// * case.1 이름을 변수로 생성
// * case.2 나이를 변수로 생성
var myName = "mark", myAge = "42";

function userName(){
    console.log(myName + '의 나이는' + myAge + '세 입니다.');
}
// * case.3 동시선언
var radius, pi;

function radiusPI(){
    console.log('radius의 data 유형은' + radius + 'PI의 data 유형은' + pi);
}

// *case.4 변수특성
var cup = 'Coffee'; //? 컵에 커피를 담았다.
cup = 'Green Tea'; //? 그 컵에 커피를 버리고, 녹차를 담았다.
cup = 'Water'; //? 그 컵에 녹차를 버리고, 물을 담았다.
