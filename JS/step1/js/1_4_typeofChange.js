...
/*
    ...
    * String(value); - 문자형으로 변환
    ...
    ? .toString()
    * NumberTarget.toString(); - 문자형(진수)변환

    ? .toFixed()
    * Number.toFixed(); - 소수점자리수(반올림발생) > 실수문자형변환
*/
function stringNumb(){
    var test1 = 15;
...
function todo1(){
    var test = 100;
    var result = test + ""; // todo. 암시적으로 형변환시키기
    console.log(typeof(result) + ' = ' + result); //todo. typeof로 자료형 검수 및 출력.
}
// todo. 1-2 String 형변환
function todo2(){
    var test = 100;
    var result = String(test); // todo. 전역함수String으로 형변환시키기
    console.log(typeof(result) + ' = ' + result); //todo. typeof로 자료형 검수 및 출력.
}
// todo. 1-3 toString 형변환
function todo3(){
    var test = 100;
    var result = test.toString(); // todo. tosTring으로 형변환시키기
    console.log(typeof(result) + ' = ' + result); //todo. typeof로 자료형 검수 및 출력.
}
...
function todo4(){
    var test = "100.51";
    var result = parseFloat(test) + 150 + parseInt("20"); // todo. parse이용한 형변환
    console.log(typeof(result) + ' = ' + result); //todo. typeof로 자료형 검수 및 출력.
}
// todo. 2-2 Number 형변환
function todo5(){
    var test = "100.51";
    var result = Number(test) + 150 + Number("20"); // todo. 전역함수 Number를 이용한 형변환
    console.log(typeof(result) + ' = ' + result); //todo. typeof로 자료형 검수 및 출력.
}