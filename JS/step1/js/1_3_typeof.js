...
*/
// *case.1 자신이 가장 좋아하는 숫자를 favorNumber변수에 담아 자료형 check.
function testTypeof(){
    var favorNumber = 1;
...
function check1(){
    var cold = false;
    console.log(typeof(cold) + ' 현재 춥냐? = ' + cold);
}
// todo.4 test 변수를 선언하고 초기화 하지 않은 상태에서 자료형을 check.
function check2(){
    var test;
    console.log(typeof(test) + ' = ' + test);
}
// todo.5 obj 변수에 객체를 담을 예정이니 null로 초기화해서 자료형을 check.
function check3(){
    var obj = null;
