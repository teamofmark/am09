...
// *case.1 자신이 가장 좋아하는 숫자를 favorNumber 변수에 담아 출력하라.
var favorNumber = 1;
// *case.2 자신의 영어이름을 engName 변수에 담아 출력하라.
var engName = 'Mark';
// *case.3 현재 자신이 춥다,아니다를 cold 변수에 담아 출력하라.
var cold = false;
// *case.4 test 변수를 선언하고 초기화 하지 않은 상태에서 출력.
var test;
// *case.5 obj 변수에 객체를 담을 예정이니 null로 초기화해서 출력.
var obj = null;

function typeofLog(){
    console.log(obj + '의 데이터 유형은' + typeof(obj) + '입니다.');
}