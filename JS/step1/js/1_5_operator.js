...
// *case.3 ul, li 구조의 tag를 htmlpage에 삽입 후 출력.
function operatorEx(){
    var list = '';
    list += '<ul>';
    list += '   <li>Hello</li>';
...
// *case.4(todo) 연산자가 뒤로 올 경우
function numberPlusAfter(){
    var number = 10; //? 변수 선언 및 초기화
    alert(number++); // todo. 10
    alert(number++); // todo. 11 
    alert(number++); // todo. 12
    //? 최종 number = ?
}

// *case.5(todo) 연산자가 앞으로 올 경우
function numberPlusBefore(){
    var number = 10; //? 변수 선언 및 초기화
    alert(++number); // todo. 11
    alert(++number); // todo. 12
    alert(++number); // todo. 13
    //? 최종 number = ?
}
// todo. 증감연산자복합.
function numberPlusTodo(){
    var number = 10;
    alert(number++); // todo. 출력숫자 : 10 -> 출력후 (11)
    alert(--number); // todo. 출력숫자 : 10 -> 출력후 (10)
    alert(++number); // todo. 출력숫자 : 11 -> 출력후 (11)
