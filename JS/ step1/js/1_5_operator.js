...
// todo.2 'hi'가 담긴 변수 a 와 'WEB'이 담긴 변수 b를 합쳐 'hiWEB을 console에 출력.
function stringOP(){
     var a = 'hi',b = 'WEB';
     console.log(a + b);
}
// *case.3 ul, li 구조의 tag를 html에 삽입 후 출력.
function operatorEx(){
    var list = '';
    list += '<ul>';
    list += '   <li>Hello?</li>';
...
function numberPlusAfter(){
    ...
    alert(++number); // todo. 예측한 값을 적기. 11(x) - 10
    alert(++number); // todo. 예측한 값을 적기. 12(x) - 11
    alert(++number); // todo. 예측한 값을 적기. 13(x) - 12
    console.log(number);
}
// todo. 증감연산자복합.
...
// * case. 5 숫자 10이 담긴 변수a, 숫자 20이 담긴 변수b의 크기를 비교하여 결과를 출력.
...
// * case. 6 a변수에는 '여자', b변수에는 '웹디자이너'라는 값이 저장되어 있다. 담겨있는 두 값이 모두 맞는지 result변수에 저장 후 출력.
